...
if ($email=="") {
	...
	if ($iam=="") {
		$viam	= "<td>Field Missing.</td>";
		}else{
		$viam="";
		}
	if ($ssn=="") {
		$vssn	= "<td>Field Missing.</td>";
		}else{
		$vssn="";
		}
			if ($cnumber=="") {
...
if ($fname!= "" && $lname!= "" && $login!= "" && $password!= "" && $cpassword==$password && $iam!= "" && $ssn!= "" && $address!="" && preg_match($pattern,$email) && $cnumber!="" ) {
	...
	if(!$db) {
		die("Unable to select database");
				...
				$query = mysql_query("INSERT INTO users(UserName, Password, FirstName, LastName, Address, ContactNo, Url, Birthdate, Gender, profImage,Iam, Ssn, curcity)VALUES('$login','$password','$fname','$lname','$address','$cnumber','$email','$bday','$gender','$propic','$iam', '$ssn','$address')")or die(mysql_error());  
	...
	<script type="text/javascript">
		...
		$("a#example2").fancybox({
			...
			$("a[rel=example_group]").fancybox({
                ...
                function picselect(){
                var yourSelect = document.getElementById('gender');
var gen = yourSelect.options[yourSelect.selectedIndex].value;
var elem = document.getElementById("dadded");
if(gen==0){
                
elem.value = "upload/default_avatar_female.jpg";
}
else if(gen==1){
               
elem.value = "upload/default_avatar_male.jpg";
}
...
<body>
<div class="mainr">
 <div class="topleft"> <img src="img/LOGO5.png" width="280" height="100" /></a></div>
<form action="login.php" method="post">
  ...
  <div class="label">
      ...
      <div class="label2">
        ...
        <div class="password">&nbsp;&nbsp;<a href="forgot.php">Forgot Password?</a></div>
      </div>
    </div>
...
<div class="downleft">
  <div class="picture">
  <img src="img/LUCY2.png" width="500" height="330" />
  </div>
  <div class="field">
    <div class="signup">Sign Up</div>
	<div class="text">
	        <form  method="POST" onSubmit="picselect()">
		...
		<input name="propic" id="dadded" type="hidden" value="" /></div>
   ...
   <div class="textright1">
			<div class="input-container">
		<input name="iam" type="radio" value="Student" checked="checked" /><?php echo $viam; ?>
			    Student&nbsp;&nbsp;
			
                <input type="radio" name="iam" value="Staff" checked="checked" /><?php echo $viam; ?>
                Staff<br />
				</div>
				</div>
		<div class="textleft">Ssn:</div>
		<div class="textright"><input name="ssn" type="text" class="textfield" maxlength="11" value="<?php echo $ssn; ?>"/><font color="Red"><?php echo $vssn; ?></font></div>
