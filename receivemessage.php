...
<div class="shoutout3">
<div class="ball">
<div class="color123">&nbsp;&nbsp;&nbsp;Recieved Message</div>
</div>
</br>
...
<?php
									...
									while($row = mysql_fetch_array($post)){
										$id = $row['receiver'];
										$hu_u = mysql_query("SELECT * FROM users WHERE user_id = '$id'")or die(mysql_error());
										$rows = mysql_fetch_array($hu_u);
										$iyaid = $row['message_id'];
										echo'<div class="information">';
										echo'<hr width=640>
										</br>';
											$sql=mysql_query("SELECT * FROM users WHERE user_id='$id'") or die(mysql_error());
