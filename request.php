...
<div class="ball">
	 ...
	 <?php 
								...
								while($pila=mysql_fetch_array($seeall)){
									...
									$fromhum=$pila['user_id'];
									$post = mysql_query("SELECT * FROM users WHERE user_id='$fromhum'")or die(mysql_error());
									...
									echo '
										...
										<div  class="rightrigh">
										<ul id="sddm">
										<li><a class="abc" href="acceptoffres.php?id='.$row['user_id'].'" rel="facebox" >Response to Friend Request</a></li><li>l</li><li><a class="abc" href="profile.php">Accept Later</a></li>
										</div></ul>
